...
def reset_game():
    ...
    ball_x = py5.width / 2
    ball_y = py5.height / 2
    ball_dx = 5  # Velocidad inicial horizontal
    ball_dy = 3  # Velocidad inicial vertical
...
def reset_ball():
    ...
    ball_x = py5.width / 2
    ball_y = py5.height / 2
    ball_dx *= -1  # Cambiar la dirección
    ball_dy = py5.random(-3, 3)

    # Aumentar la velocidad después de cada punto
    ball_dx *= 1.1  # Aumentar la velocidad horizontal un 10% después de cada punto
    ball_dy *= 1.1  # Aumentar la velocidad vertical un 10% después de cada punto
